...
\begin{figure}
  ...
  \subfigure[CVFEM P=1.]
  {
    \includegraphics[height=1.5in]{images/cvfemHO_P1}
  }
  \subfigure [CVFEM P=2.]
  {
    \includegraphics[height=1.5in]{images/cvfemHO_P2}
  }
  \vspace{0.1in}
...
Consider Fig.~\ref{convol}, which is the original set of CVFEM

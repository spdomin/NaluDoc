...
contributions averaged over the two elements. Note that the lack of averaging the mass flow rate, 
...
rate above provides the continuity contribution.

As a final note, the full connectivity for element integration and opposing elements is within the linear 
system. As such, for sliding mesh configurations, the linear system connectivity graph changes each time step.
